const { Client, GatewayIntentBits, PermissionsBitField, PermissionFlagsBits, ChannelType, Partials } = require('discord.js');
    ...
    if (interaction.isChatInputCommand()) {
        ...
        try {
            if (interaction.channel.type != ChannelType.DM) {
                ...
                if (!devs.includes(interaction.member.user.id) && command.memberPermissions.some(p => !interaction.member.permissions.has(p)))
